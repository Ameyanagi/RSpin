...
pub use dimension_metadata_strict::*;
...
pub use exact::{
    ...
    load_spectrum_1d_by_sources, load_spectrum_1d_by_sources_relative_to, load_spectrum_1d_many,
    ...
    load_spectrum_1d_many_by_source_format_relative_to, load_spectrum_1d_many_by_source_path,
    ...
    load_spectrum_1d_many_by_source_path_prefixes_relative_to,
    load_spectrum_1d_many_by_source_path_relative_to, load_spectrum_1d_many_by_source_relative_to,
    ...
    load_spectrum_1d_many_with_source_by_source_path_prefixes,
    load_spectrum_1d_many_with_source_by_source_path_prefixes_relative_to,
    ...
    load_spectrum_1d_with_source_by_source_path_prefixes,
    load_spectrum_1d_with_source_by_source_path_prefixes_relative_to,
    ...
    load_spectrum_2d_by_source_path_prefix_relative_to, load_spectrum_2d_by_source_path_prefixes,
    load_spectrum_2d_by_source_path_prefixes_relative_to,
    ...
    load_spectrum_2d_by_sources, load_spectrum_2d_by_sources_relative_to, load_spectrum_2d_many,
    load_spectrum_2d_many_by_source, load_spectrum_2d_many_by_source_data_kind,
    load_spectrum_2d_many_by_source_data_kind_relative_to, load_spectrum_2d_many_by_source_format,
    load_spectrum_2d_many_by_source_format_relative_to, load_spectrum_2d_many_by_source_path,
    load_spectrum_2d_many_by_source_path_prefix,
    load_spectrum_2d_many_by_source_path_prefix_relative_to,
    load_spectrum_2d_many_by_source_path_prefixes,
    load_spectrum_2d_many_by_source_path_prefixes_relative_to,
    load_spectrum_2d_many_by_source_path_relative_to, load_spectrum_2d_many_by_source_relative_to,
    ...
    load_spectrum_2d_many_with_source_by_source_path_prefixes,
...
pub use loader::{
    ...
    SelectedDiscoveredSpectrumSourcesExt, SpectrumBundleLoader, load_discovered_spectra,
    ...
    load_discovered_spectra_1d_by_source_paths,
    load_discovered_spectra_1d_by_source_paths_relative_to,
    ...
    load_discovered_spectra_1d_strict_by_source_paths,
    load_discovered_spectra_1d_strict_by_source_paths_relative_to,
    ...
    load_discovered_spectra_1d_strict_relative_to, load_discovered_spectra_1d_summary,
    ...
    load_discovered_spectra_1d_summary_by_source_paths,
    load_discovered_spectra_1d_summary_by_source_paths_relative_to,
    ...
    load_discovered_spectra_1d_summary_strict_by_source_paths,
    ...
    load_discovered_spectra_1d_summary_strict_relative_to, load_discovered_spectra_2d,
    load_discovered_spectra_2d_by_source, load_discovered_spectra_2d_by_source_path,
    load_discovered_spectra_2d_by_source_path_prefix,
    ...
    load_discovered_spectra_2d_by_source_paths,
    load_discovered_spectra_2d_by_source_paths_relative_to,
    load_discovered_spectra_2d_by_source_relative_to, load_discovered_spectra_2d_by_sources,
    load_discovered_spectra_2d_by_sources_relative_to, load_discovered_spectra_2d_relative_to,
    load_discovered_spectra_2d_strict, load_discovered_spectra_2d_strict_by_source,
    ...
    load_discovered_spectra_2d_strict_by_source_paths,
    load_discovered_spectra_2d_strict_by_source_paths_relative_to,
    ...
    load_discovered_spectra_2d_strict_relative_to, load_discovered_spectra_2d_summary,
    ...
    load_discovered_spectra_2d_summary_by_source_paths,
    load_discovered_spectra_2d_summary_by_source_paths_relative_to,
    ...
    load_discovered_spectra_2d_summary_strict_by_source_paths,
    ...
    load_discovered_spectra_2d_summary_strict_relative_to, load_discovered_spectra_by_source,
    ...
    load_discovered_spectra_by_source_formats_relative_to, load_discovered_spectra_by_source_path,
    ...
    load_discovered_spectra_by_source_relative_to, load_discovered_spectra_by_source_vendor,
    load_discovered_spectra_by_source_vendor_relative_to,
    load_discovered_spectra_by_source_vendors,
    load_discovered_spectra_by_source_vendors_relative_to, load_discovered_spectra_by_sources,
    ...
    load_discovered_spectra_strict_relative_to, load_discovered_spectra_summary,
    load_discovered_spectra_summary_by_source, load_discovered_spectra_summary_by_source_data_kind,
    ...
    load_discovered_spectra_summary_strict_relative_to, load_discovered_spectrum_1d,
    load_discovered_spectrum_1d_by_source, load_discovered_spectrum_1d_by_source_path,
    load_discovered_spectrum_1d_by_source_path_prefix,
    ...
    load_discovered_spectrum_2d_by_source, load_discovered_spectrum_2d_by_source_path,
    load_discovered_spectrum_2d_by_source_path_prefix,
...
pub fn discover_spectra(path: impl AsRef<Path>) -> Result<Vec<DiscoveredSpectrumSource>> {
...
/// Discovers one-dimensional source candidates below a file or directory without loading full spectra.
///
/// # Errors
///
/// Returns an error when the path is missing or a directory cannot be read.
pub fn discover_spectra_1d(path: impl AsRef<Path>) -> Result<Vec<DiscoveredSpectrumSource>> {
    SpectrumBundleLoader::new().discover_1d_path(path)
}

/// Discovers two-dimensional source candidates below a file or directory without loading full spectra.
///
/// # Errors
///
/// Returns an error when the path is missing or a directory cannot be read.
pub fn discover_spectra_2d(path: impl AsRef<Path>) -> Result<Vec<DiscoveredSpectrumSource>> {
    SpectrumBundleLoader::new().discover_2d_path(path)
}
...
///
/// Returns an error when the path is missing or a directory cannot be read.
pub fn discover_spectra_1d_summary(path: impl AsRef<Path>) -> Result<DiscoveredSpectrumSummary> {
    SpectrumBundleLoader::new().discover_1d_summary_path(path)
}
...
///
/// Returns an error when the path is missing or a directory cannot be read.
pub fn discover_spectra_2d_summary(path: impl AsRef<Path>) -> Result<DiscoveredSpectrumSummary> {
    SpectrumBundleLoader::new().discover_2d_summary_path(path)
}
...
pub fn discover_spectra_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
...
/// Returns an error when `base` is missing or is not a directory, or the
/// selected path is missing.
pub fn discover_spectra_1d_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
) -> Result<Vec<DiscoveredSpectrumSource>> {
    SpectrumBundleLoader::new().discover_1d_relative_to(base, path)
}
...
/// Returns an error when `base` is missing or is not a directory, or the
/// selected path is missing.
pub fn discover_spectra_2d_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
) -> Result<Vec<DiscoveredSpectrumSource>> {
    SpectrumBundleLoader::new().discover_2d_relative_to(base, path)
}
...
/// Returns an error when `base` is missing or is not a directory, or the
/// selected path is missing.
pub fn discover_spectra_1d_summary_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
) -> Result<DiscoveredSpectrumSummary> {
    SpectrumBundleLoader::new().discover_1d_summary_relative_to(base, path)
}
...
/// Returns an error when `base` is missing or is not a directory, or the
/// selected path is missing.
pub fn discover_spectra_2d_summary_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
) -> Result<DiscoveredSpectrumSummary> {
    SpectrumBundleLoader::new().discover_2d_summary_relative_to(base, path)
}
...
/// Loads one selected path relative to a base directory, restricted by one generic source filter.
///
/// # Errors
///
/// Returns an error when `base` is missing or is not a directory, the path is
/// unreadable in strict mode, or no matching readable bundle data is found.
pub fn load_spectra_by_source_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    filter: impl Into<LoadedSourceFilter>,
) -> Result<SpectrumBundle> {
...
/// Returns an error when the path is missing or no matching readable bundle
/// data is found.
pub fn load_spectra_by_sources<I, F>(path: impl AsRef<Path>, filters: I) -> Result<SpectrumBundle>
where
    I: IntoIterator<Item = F>,
    F: Into<LoadedSourceFilter>,
{
...
/// Loads one selected path relative to a base directory, restricted by generic source filters.
///
/// Relative input paths are resolved below `base`; absolute input paths are
/// loaded as provided. Filters are combined with logical OR.
///
/// # Errors
///
/// Returns an error when `base` is missing or is not a directory, the path is
/// unreadable in strict mode, or no matching readable bundle data is found.
pub fn load_spectra_by_sources_relative_to<I, F>(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    filters: I,
) -> Result<SpectrumBundle>
...
pub fn discover_spectra_many<I, P>(paths: I) -> Result<Vec<DiscoveredSpectrumSource>>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
{
...
/// Returns an error when no input paths are provided, an input path is missing,
/// or a directory cannot be read.
pub fn discover_spectra_1d_many<I, P>(paths: I) -> Result<Vec<DiscoveredSpectrumSource>>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_1d_many(paths)
}
...
/// Returns an error when no input paths are provided, an input path is missing,
/// or a directory cannot be read.
pub fn discover_spectra_2d_many<I, P>(paths: I) -> Result<Vec<DiscoveredSpectrumSource>>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_2d_many(paths)
}
...
/// Returns an error when no input paths are provided, an input path is missing,
/// or a directory cannot be read.
pub fn discover_spectra_1d_many_summary<I, P>(paths: I) -> Result<DiscoveredSpectrumSummary>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_1d_summary_many(paths)
}
...
/// Returns an error when no input paths are provided, an input path is missing,
/// or a directory cannot be read.
pub fn discover_spectra_2d_many_summary<I, P>(paths: I) -> Result<DiscoveredSpectrumSummary>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_2d_summary_many(paths)
}
...
pub fn discover_spectra_many_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
) -> Result<Vec<DiscoveredSpectrumSource>>
where
...
/// Returns an error when `base` is missing or is not a directory, no input
/// paths are provided, a selected path is missing, or a directory cannot be read.
pub fn discover_spectra_1d_many_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
) -> Result<Vec<DiscoveredSpectrumSource>>
where
    ...
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_1d_many_relative_to(base, paths)
}
...
/// Returns an error when `base` is missing or is not a directory, no input
/// paths are provided, a selected path is missing, or a directory cannot be read.
pub fn discover_spectra_2d_many_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
) -> Result<Vec<DiscoveredSpectrumSource>>
where
    ...
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_2d_many_relative_to(base, paths)
}
...
/// Returns an error when `base` is missing or is not a directory, no input
/// paths are provided, a selected path is missing, or a directory cannot be read.
pub fn discover_spectra_1d_many_summary_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
) -> Result<DiscoveredSpectrumSummary>
where
    ...
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_1d_summary_many_relative_to(base, paths)
}
...
/// Returns an error when `base` is missing or is not a directory, no input
/// paths are provided, a selected path is missing, or a directory cannot be read.
pub fn discover_spectra_2d_many_summary_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
) -> Result<DiscoveredSpectrumSummary>
where
    ...
    P: AsRef<Path>,
{
    SpectrumBundleLoader::new().discover_2d_summary_many_relative_to(base, paths)
}
...
pub fn load_spectra_many_by_source<I, P>(
    paths: I,
    filter: impl Into<LoadedSourceFilter>,
) -> Result<SpectrumBundle>
where
...
/// Loads selected paths relative to a base directory, restricted by one generic source filter.
///
/// Relative input paths are resolved below `base`; absolute input paths are
/// loaded as provided.
///
...
pub fn load_spectra_many_by_source_relative_to<I, P>(
    base: impl AsRef<Path>,
    paths: I,
    filter: impl Into<LoadedSourceFilter>,
) -> Result<SpectrumBundle>
...
/// Returns an error when no input paths are provided or no matching readable
/// bundle data is found.
pub fn load_spectra_many_by_sources<I, P, J, F>(paths: I, filters: J) -> Result<SpectrumBundle>
where
    I: IntoIterator<Item = P>,
    P: AsRef<Path>,
    J: IntoIterator<Item = F>,
...
/// Loads selected paths relative to a base directory, restricted by generic source filters.
///
/// Relative input paths are resolved below `base`; absolute input paths are
/// loaded as provided. Filters are combined with logical OR.
///
...
/// Returns an error when `base` is missing or is not a directory, no input
/// paths are provided, or no matching readable bundle data is found.
pub fn load_spectra_many_by_sources_relative_to<I, P, J, F>(
    base: impl AsRef<Path>,
    paths: I,
    filters: J,
) -> Result<SpectrumBundle>
