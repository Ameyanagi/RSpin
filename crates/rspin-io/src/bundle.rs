...
pub use exact::{
    ...
    load_spectrum_1d_many, load_spectrum_1d_many_by_source, load_spectrum_1d_many_by_source_format,
    ...
    load_spectrum_2d_many_by_source, load_spectrum_2d_many_by_source_format,
