...
pub use bundle::{
    ...
    LoadedSpectrum, RSpinReader, SourceDataKindCount, SourceFormatCount, SourcePathCount,
    SourceVendorCount, SpectrumBundle, SpectrumBundleLoader, SpectrumBundleSummary,
    WarningPathCount, discover_spectra, discover_spectra_by_source,
