...
pub use bundle::{
    ...
    SpectrumBundle, SpectrumBundleLoader, SpectrumBundleSummary, discover_spectra,
    discover_spectra_many, discover_spectra_many_relative_to, discover_spectra_relative_to,
    load_discovered_spectra, load_discovered_spectra_relative_to, load_spectra,
