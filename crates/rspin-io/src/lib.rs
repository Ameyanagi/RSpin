...
pub use bundle::{
    ...
    load_discovered_spectrum_2d_with_source_relative_to, load_spectra, load_spectra_by_source,
    ...
    load_spectra_by_source_path_prefix_relative_to, load_spectra_by_source_path_prefixes,
    load_spectra_by_source_path_prefixes_relative_to, load_spectra_by_source_path_relative_to,
    ...
    load_spectra_many_by_source_path_prefix_relative_to, load_spectra_many_by_source_path_prefixes,
