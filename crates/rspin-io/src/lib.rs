...
pub use bundle::{
    ...
    load_spectra_by_source_vendor_relative_to, load_spectra_many, load_spectra_many_by_source,
    ...
    load_spectra_many_by_source_vendor_relative_to, load_spectra_many_relative_to,
    load_spectra_relative_to, load_spectrum_1d, load_spectrum_1d_by_source_format,
