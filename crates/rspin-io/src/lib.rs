...
pub use bundle::{
    ...
    load_spectra_1d_many, load_spectra_1d_many_relative_to, load_spectra_1d_relative_to,
    load_spectra_2d, load_spectra_2d_many, load_spectra_2d_many_relative_to,
    load_spectra_2d_relative_to, load_spectra_by_source, load_spectra_by_source_data_kind,
