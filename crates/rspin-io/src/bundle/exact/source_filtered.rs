...
impl SpectrumBundleLoader {
    ...
    /// Loads exactly one one-dimensional spectrum read from a tracked source path.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// one-dimensional spectrum is not found.
    pub fn read_1d_by_source_path(
        &self,
        path: impl AsRef<Path>,
    ...
    /// Loads exactly one one-dimensional spectrum and source read from a tracked source path.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// one-dimensional spectrum is not found.
    pub fn read_1d_with_source_by_source_path(
        &self,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ) -> Result<(Spectrum1D, LoadedSource)> {
    ...
    /// Loads exactly one two-dimensional spectrum read from a tracked source path.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// two-dimensional spectrum is not found.
    pub fn read_2d_by_source_path(
        &self,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ) -> Result<Spectrum2D> {
    ...
    /// Loads exactly one two-dimensional spectrum and source read from a tracked source path.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// two-dimensional spectrum is not found.
    pub fn read_2d_with_source_by_source_path(
        &self,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ) -> Result<(Spectrum2D, LoadedSource)> {
    ...
    /// Loads exactly one one-dimensional spectrum read from a tracked source path while anchoring input to a base directory.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// one-dimensional spectrum is not found.
    pub fn read_1d_by_source_path_relative_to(
        &self,
        base: impl AsRef<Path>,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ...
    /// Loads exactly one one-dimensional spectrum and source read from a tracked source path while anchoring input to a base directory.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// one-dimensional spectrum is not found.
    pub fn read_1d_with_source_by_source_path_relative_to(
        &self,
        base: impl AsRef<Path>,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ...
    /// Loads exactly one two-dimensional spectrum read from a tracked source path while anchoring input to a base directory.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// two-dimensional spectrum is not found.
    pub fn read_2d_by_source_path_relative_to(
        &self,
        base: impl AsRef<Path>,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
    ...
    /// Loads exactly one two-dimensional spectrum and source read from a tracked source path while anchoring input to a base directory.
    ///
    /// # Errors
    ///
    /// Returns an error when loading fails or exactly one matching
    /// two-dimensional spectrum is not found.
    pub fn read_2d_with_source_by_source_path_relative_to(
        &self,
        base: impl AsRef<Path>,
        path: impl AsRef<Path>,
        source_path: impl AsRef<Path>,
...
/// Returns an error when loading fails or exactly one matching one-dimensional
/// spectrum is not found.
pub fn load_spectrum_1d_by_source_path(
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<Spectrum1D> {
    SpectrumBundleLoader::new().read_1d_by_source_path(path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching one-dimensional
/// spectrum is not found.
pub fn load_spectrum_1d_with_source_by_source_path(
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<(Spectrum1D, LoadedSource)> {
    SpectrumBundleLoader::new().read_1d_with_source_by_source_path(path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching two-dimensional
/// spectrum is not found.
pub fn load_spectrum_2d_by_source_path(
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<Spectrum2D> {
    SpectrumBundleLoader::new().read_2d_by_source_path(path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching two-dimensional
/// spectrum is not found.
pub fn load_spectrum_2d_with_source_by_source_path(
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<(Spectrum2D, LoadedSource)> {
    SpectrumBundleLoader::new().read_2d_with_source_by_source_path(path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching one-dimensional
/// spectrum is not found.
pub fn load_spectrum_1d_by_source_path_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<Spectrum1D> {
    SpectrumBundleLoader::new().read_1d_by_source_path_relative_to(base, path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching one-dimensional
/// spectrum is not found.
pub fn load_spectrum_1d_with_source_by_source_path_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<(Spectrum1D, LoadedSource)> {
    SpectrumBundleLoader::new().read_1d_with_source_by_source_path_relative_to(
        base,
        path,
        source_path,
    )
...
/// Returns an error when loading fails or exactly one matching two-dimensional
/// spectrum is not found.
pub fn load_spectrum_2d_by_source_path_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<Spectrum2D> {
    SpectrumBundleLoader::new().read_2d_by_source_path_relative_to(base, path, source_path)
}
...
/// Returns an error when loading fails or exactly one matching two-dimensional
/// spectrum is not found.
pub fn load_spectrum_2d_with_source_by_source_path_relative_to(
    base: impl AsRef<Path>,
    path: impl AsRef<Path>,
    source_path: impl AsRef<Path>,
) -> Result<(Spectrum2D, LoadedSource)> {
    SpectrumBundleLoader::new().read_2d_with_source_by_source_path_relative_to(
        base,
        path,
        source_path,
    )
