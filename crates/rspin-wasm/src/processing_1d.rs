...
/// Crops a serialized one-dimensional spectrum to an inclusive x-axis window.
///
/// # Errors
///
/// Returns a JavaScript error string when deserialization, processing, or
/// serialization fails.
#[wasm_bindgen(js_name = cropSpectrum1d)]
pub fn crop_spectrum_1d(
    spectrum_json: &str,
    from: f64,
    to: f64,
) -> std::result::Result<String, JsValue> {
...
/// Applies Gaussian apodization to a serialized one-dimensional spectrum.
///
/// # Errors
///
/// Returns a JavaScript error string when deserialization, processing, or
/// serialization fails.
#[wasm_bindgen(js_name = gaussianApodizationSpectrum1d)]
pub fn gaussian_apodization_spectrum_1d(
    spectrum_json: &str,
    options_json: &str,
) -> std::result::Result<String, JsValue> {
...
/// Applies a serialized processing recipe to a serialized one-dimensional spectrum.
///
/// # Errors
///
/// Returns a JavaScript error string when deserialization, processing, or
/// serialization fails.
#[wasm_bindgen(js_name = applyProcessingRecipe1d)]
