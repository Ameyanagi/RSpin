...
pub use api::{
    ...
    spectrum_bundle_1d_by_source_vendor_json, spectrum_bundle_2d_by_source_data_kind_json,
    spectrum_bundle_2d_by_source_format_json, spectrum_bundle_2d_by_source_path_json,
    spectrum_bundle_2d_by_source_vendor_json, spectrum_bundle_counts_json,
...
pub use io::{
    ...
    spectrum_bundle_1d_by_source_vendor, spectrum_bundle_2d_by_source_data_kind,
    spectrum_bundle_2d_by_source_format, spectrum_bundle_2d_by_source_path,
    spectrum_bundle_2d_by_source_vendor, spectrum_bundle_counts,
