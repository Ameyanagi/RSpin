...
pub use api::{
    ...
    nmredata_to_analysis_json, normalize_spectrum_1d_json, normalize_spectrum_2d_json,
...
pub use io::{
    ...
    nmredata_to_analysis, parse_nmredata, parse_nmredata_records, parse_nmrml_1d, parse_nmrml_2d,
