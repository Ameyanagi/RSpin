...
pub use processing_2d::{
    ...
    gaussian_apodization_spectrum_2d, normalize_spectrum_2d, phase_spectrum_2d,
    project_spectrum_2d_x, project_spectrum_2d_y, resample_spectrum_2d, scale_spectrum_2d,
