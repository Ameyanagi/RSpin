...
pub use api::{
    ...
    slice_spectrum_2d_y_at_x_json, spectrum_bundle_counts_json, spectrum_bundle_only_1d_json,
    spectrum_bundle_only_2d_json, spectrum_bundle_source_formats_json,
...
pub use io::{
    ...
    spectrum_bundle_only_1d, spectrum_bundle_only_2d, spectrum_bundle_source_formats,
