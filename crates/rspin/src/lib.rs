...
pub use io::{
    ...
    NmrMlDocumentInfo, NmrMlSchemaLocation, Spectrum1DPathFormat, Spectrum2DPathFormat,
...
pub use processing::{
    ...
    magnitude_spectrum, normalize_2d_max_abs, normalize_max_abs, offset_intensity, phase_correct,
    phase_correct_2d, project_x, project_y, resample_1d, resample_2d, scale_2d, scale_intensity,
    shift_axis, slice_x_at_y, slice_x_at_y_index, slice_y_at_x, slice_y_at_x_index,
...
pub mod prelude {
    pub use crate::{
        ...
        NmrMl1D, NmrMl2D, NmrMlDocumentInfo, NmrMlSchemaLocation, Nucleus, OptimizedPeak, Peak,
        PeakAlignedMatrix1D, PeakAlignmentOptions, PeakOptimizationOptions, PeakOptimizer,
        ...
        SimulateExactSpinHalfResult, SpectralBucket1D, SpectralBucket2D, Spectrum1D,
        Spectrum1DPathFormat, Spectrum2D, Spectrum2DAlignmentShift, Spectrum2DPathFormat,
