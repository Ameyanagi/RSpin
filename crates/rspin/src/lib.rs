...
pub use analysis::{
    AlignmentWindow, AnalyzeSpectrum1D, AnalyzeSpectrum2D, AssignedAtom, Assignment, AssignmentSet,
    AssignmentTarget, BilinearIntegrator2D, BucketMatrix1D, BucketMatrix2D, BucketOptions1D,
    BucketOptions2D, ClusterMerge, ConsensusPeak1D, ConsensusPeakMember1D, ConsensusPeakOptions,
    ConsensusRange1D, ConsensusRangeMember1D, ConsensusRangeOptions, ConsensusZone2D,
    ConsensusZoneMember2D, ConsensusZoneOptions, CouplingNode, DetectedMultiplet, DetectedRange,
    ...
    SpectrumAnalysis2DWorkflow, SpectrumMatrix1D, SpectrumMatrix2D, ThresholdRangeDetector,
    ThresholdZoneDetector, TrapezoidalIntegrator, ZoneAlignedMatrix2D, ZoneAlignmentOptions,
    ZoneAlignmentResult2D, ZoneConnectivity, ZoneDetectionOptions, ZoneDetector,
    align_spectra_by_peak, align_spectra_by_peak_to_matrix, align_spectra_by_zone,
    align_spectra_by_zone_to_matrix, analyze_assigned_spectrum_1d, analyze_assigned_spectrum_2d,
    analyze_spectrum_1d, analyze_spectrum_2d, bucket_spectra_1d, bucket_spectra_2d,
    ...
    detect_consensus_peaks_1d, detect_consensus_ranges_1d, detect_consensus_zones_2d,
    ...
    integrate_region, integrate_region_2d, optimize_peaks_quadratic, pairwise_bucket_matrix_1d,
...
pub use io::{
    AgilentFid1D, AgilentFid2D, AutoSpectrum1DText, AutoSpectrum2DText, BrukerFid1D,
    BrukerProcessed1D, BrukerProcessed2D, BrukerSer2D, CsvAnalysis1D, CsvAnalysis2D, CsvSpectrum1D,
    CsvSpectrum2D, JcampDx, JeolJdf1D, JeolJdf2D, JsonAnalysis1D, JsonAnalysis2D,
    JsonProcessingRecipe1D, JsonProcessingRecipe2D, JsonSpectrum1D, JsonSpectrum2D, NmrMl1D,
    NmrMl2D, SpectrumReader, SpectrumTextFormat, SpectrumWriter, detect_spectrum_text_format,
    ...
    read_spectrum1d_json, read_spectrum1d_text, read_spectrum2d_csv, read_spectrum2d_json,
    read_spectrum2d_text, write_analysis1d_csv, write_analysis1d_json, write_analysis2d_csv,
...
pub mod prelude {
    pub use crate::{
        ...
        AnalyzeSpectrum2D, AnnotationTarget, AssignedAtom, Assignment, AssignmentSet,
        AssignmentTarget, Atom, AutoPhaseOptions, AutoSpectrum1DText, AutoSpectrum2DText, Axis,
        ...
        SpectralBucket2D, Spectrum1D, Spectrum2D, Spectrum2DAlignmentShift, SpectrumAnalysis1D,
        SpectrumAnalysis1DOptions, SpectrumAnalysis1DWorkflow, SpectrumAnalysis2D,
        SpectrumAnalysis2DOptions, SpectrumAnalysis2DWorkflow, SpectrumAnnotation,
        SpectrumMatrix1D, SpectrumMatrix2D, SpectrumReader, SpectrumTextFormat, SpectrumWriter,
        ...
        detect_spectrum_text_format, detect_zones, exact_spin_half_transitions, extract_contours,
        generate_spectrum_matrix_1d, generate_spectrum_matrix_2d, integrate_region,
        integrate_region_2d, normalize_max_abs, pairwise_bucket_matrix_1d,
        pairwise_bucket_matrix_2d, pairwise_matrix, pairwise_spectrum_matrix_1d,
        pairwise_spectrum_matrix_2d, pca_bucket_matrix_1d, pca_bucket_matrix_2d, pca_matrix,
        ...
        read_spectrum1d_text, read_spectrum2d_csv, read_spectrum2d_json, read_spectrum2d_text,
        ...
        subtract_baseline, summarize_signals_2d, write_analysis1d_csv, write_analysis1d_json,
