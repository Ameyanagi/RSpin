...
pub use processing::{
    ...
    ProjectionMode, Resample1D, Scale2D, ScaleIntensity, ShiftAxis, Spectrum1DPipeline,
    ...
    project_x, project_y, resample_1d, scale_2d, scale_intensity, shift_axis, slice_x_at_y,
    slice_x_at_y_index, slice_y_at_x, slice_y_at_x_index, subtract_baseline, zero_fill,
    zero_fill_2d,
};
pub use simulation::{
...
pub mod prelude {
    pub use crate::{
        ...
        ProjectionMode, RSpinError, RangeDetectionOptions, Resample1D, Result, ScalarCoupling,
        SignalSummary1D, SignalSummaryOptions, Spectrum1D, Spectrum2D, SpectrumReader,
        SpectrumWriter, SpinHalf, SpinHalfSystem, Unit, ZoneConnectivity, ZoneDetectionOptions,
        align_spectra_by_peak, auto_phase_correct, auto_phase_correct_2d, crop_1d, crop_2d,
        decompose_exact_spin_half_1d, detect_multiplets, detect_ranges, detect_zones,
        exact_spin_half_transitions, extract_contours, integrate_region, normalize_max_abs,
        pick_peaks, read_jcamp_dx_1d, read_spectrum1d_csv, read_spectrum1d_json,
        read_spectrum2d_csv, read_spectrum2d_json, render_prediction_1d, resample_1d,
