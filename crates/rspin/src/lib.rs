...
pub use io::{
    ...
    CsvSpectrum1D, CsvSpectrum2D, EXACT_DECOMPOSITION_1D_JSON_FORMAT,
    ...
    detect_spectrum2d_write_path_format, inspect_agilent_binary_bytes, inspect_agilent_binary_file,
    inspect_agilent_procpar, inspect_bruker_parameter_file, inspect_jeol_jdf_bytes,
    inspect_jeol_jdf_file, load_spectra, load_spectra_by_source, load_spectra_by_source_data_kind,
...
pub mod prelude {
    pub use crate::{
        ...
        CsvSpectrum2D, DetectedMultiplet, DetectedRange, DetectedZone,
