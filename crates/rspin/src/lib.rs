...
pub use analysis::{
    ...
    BilinearIntegrator2D, BucketMatrix1D, BucketOptions1D, CouplingNode, DetectedMultiplet,
    DetectedRange, DetectedZone, GapMultipletDetector, Integral, Integral2D, IntegralRegion,
    IntegralRegion2D, Integrator, Integrator2D, JCoupling, JCouplingGraph, LocalExtremaPeakPicker,
    MatrixGeneration2DOptions, MatrixGenerationOptions, MultipletDetectionOptions,
    MultipletDetector, MultipletKind, OptimizedPeak, Peak, PeakAlignedMatrix1D,
    ...
    RangeDetector, SignalSummary1D, SignalSummary2D, SignalSummary2DOptions, SignalSummaryOptions,
    SpectralBucket1D, SpectrumAlignmentShift, SpectrumMatrix1D, SpectrumMatrix2D,
    ...
    bucket_spectra_1d, bucket_spectrum_1d, detect_multiplets, detect_ranges, detect_zones,
...
pub mod prelude {
    pub use crate::{
        ...
        BondOrder, BucketMatrix1D, BucketOptions1D, Crop1D, Crop2D, CsvSpectrum1D, CsvSpectrum2D,
        ...
        LineShape, MatrixGeneration2DOptions, MatrixGenerationOptions, Metadata, Molecule,
        ...
        SignalSummary2DOptions, SignalSummaryOptions, SpectralBucket1D, Spectrum1D, Spectrum2D,
        SpectrumAnnotation, SpectrumMatrix1D, SpectrumMatrix2D, SpectrumReader, SpectrumWriter,
        SpinHalf, SpinHalfSystem, TrapezoidalIntegrator, Unit, ZoneConnectivity,
        ...
        bucket_spectra_1d, bucket_spectrum_1d, crop_1d, crop_2d, decompose_exact_spin_half_1d,
        ...
        integrate_region, integrate_region_2d, normalize_max_abs, pick_peaks,
        predict_molecule_with_rules, read_jcamp_dx_1d, read_spectrum1d_csv, read_spectrum1d_json,
