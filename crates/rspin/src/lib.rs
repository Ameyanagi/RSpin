...
pub use analysis::{
    ...
    RangeDetectionOptions, RangeDetector, SignalSummary1D, SignalSummaryOptions,
    ...
    ZoneDetector, align_spectra_by_peak, detect_multiplets, detect_ranges, detect_zones,
...
pub mod prelude {
    pub use crate::{
        ...
        Spectrum2D, SpectrumMatrix1D, SpectrumMatrix2D, SpectrumReader, SpectrumWriter, SpinHalf,
        SpinHalfSystem, TrapezoidalIntegrator, Unit, ZoneConnectivity, ZoneDetectionOptions,
        abs_1d, abs_2d, align_spectra_by_peak, auto_phase_correct, auto_phase_correct_2d, crop_1d,
