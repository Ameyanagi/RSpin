...
pub use io::{
    ...
    SPIN_HALF_SYSTEM_JSON_FORMAT, SourceDataKindCount, SourceFormatCount, SourcePathCount,
    SourceVendorCount, Spectrum1DBytes, Spectrum1DBytesFormat, Spectrum1DPathFormat,
    Spectrum1DTextWriter, Spectrum1DWriteFormat, Spectrum1DWritePathFormat, Spectrum2DBytes,
    Spectrum2DBytesFormat, Spectrum2DPathFormat, Spectrum2DTextWriter, Spectrum2DWriteFormat,
    Spectrum2DWritePathFormat, SpectrumBundle, SpectrumBundleLoader, SpectrumBundleSummary,
    SpectrumPathReader, SpectrumPathWriter, SpectrumReader, SpectrumTextFormat, SpectrumWriter,
    WarningPathCount, detect_spectrum_text_format, detect_spectrum1d_path_format,
    detect_spectrum1d_write_path_format, detect_spectrum2d_path_format,
    detect_spectrum2d_write_path_format, discover_spectra, discover_spectra_by_source,
    ...
    inspect_jeol_jdf_bytes, inspect_jeol_jdf_file, load_discovered_spectra,
    ...
    load_spectrum_2d_with_source_relative_to, nmredata_1d_signals_to_assignment_set,
    ...
    nmredata_to_analysis, parse_jcamp_dx_version, parse_loaded_source_data_kind,
    parse_loaded_source_format, parse_loaded_source_vendor, parse_nmredata_version,
...
pub mod prelude {
    pub use crate::{
        ...
        ScalarCoupling, Shift2DAxes, SignalSummary1D, SignalSummary2D, SignalSummary2DOptions,
        SignalSummaryOptions, SimulateExactSpinHalf, SimulateExactSpinHalfResult,
        SineBellApodization, SineBellApodization2D, SourceDataKindCount, SourceFormatCount,
        SourcePathCount, SourceVendorCount, SpectralBucket1D, SpectralBucket2D, Spectrum1D,
        Spectrum1DBytes, Spectrum1DBytesFormat, Spectrum1DPathFormat, Spectrum1DTextWriter,
        Spectrum1DWriteFormat, Spectrum1DWritePathFormat, Spectrum2D, Spectrum2DAlignmentShift,
        Spectrum2DBytes, Spectrum2DBytesFormat, Spectrum2DPathFormat, Spectrum2DTextWriter,
        Spectrum2DWriteFormat, Spectrum2DWritePathFormat, SpectrumAnalysis1D,
        ...
        SpinHalfSystem, TrapezoidalIntegrator, Unit, WarningPathCount, ZoneAlignedMatrix2D,
        ...
        integrate_regions, integrate_regions_2d, integrate_zones_2d, load_discovered_spectra,
        load_discovered_spectra_1d, load_discovered_spectra_1d_by_source,
        load_discovered_spectra_1d_by_source_relative_to, load_discovered_spectra_1d_by_sources,
        load_discovered_spectra_1d_by_sources_relative_to, load_discovered_spectra_1d_relative_to,
        load_discovered_spectra_1d_strict, load_discovered_spectra_1d_strict_by_source,
