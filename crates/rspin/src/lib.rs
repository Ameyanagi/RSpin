...
pub use io::{
    ...
    Spectrum2DPathFormat, SpectrumPathReader, SpectrumPathWriter, SpectrumReader,
    SpectrumTextFormat, SpectrumWriter, detect_spectrum_text_format, detect_spectrum1d_path_format,
    detect_spectrum2d_path_format, parse_nmrml_version, read_agilent_fid_1d_dir,
...
pub mod prelude {
    pub use crate::{
        ...
        detect_zones, exact_spin_half_transitions, extract_contours, gaussian_apodization,
