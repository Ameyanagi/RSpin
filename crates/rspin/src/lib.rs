...
pub use io::{
    AgilentFid1D, AgilentFid2D, AgilentProcessed1D, AutoSpectrum1DPath, AutoSpectrum1DPathWriter,
    ...
    CsvSpectrum1D, CsvSpectrum2D, JcampDx, JeolJdf1D, JeolJdf2D, JsonAnalysis1D, JsonAnalysis2D,
...
pub mod prelude {
    pub use crate::{
        Abs1D, Abs2D, AgilentFid1D, AgilentFid2D, AgilentProcessed1D, AlignmentWindow,
