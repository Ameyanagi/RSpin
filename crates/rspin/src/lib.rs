...
pub use processing::{
    ...
    ContourSegment, ContourSet, ExponentialApodization, ExponentialApodization2D, Fft1D, Fft2D,
    FftDirection, Magnitude, Normalize2DMaxAbs, NormalizeMaxAbs, OffsetIntensity, PhaseCorrection,
    PhaseCorrection2D, ProcessSpectrum1D, ProcessSpectrum2D, ProcessingStep, ProjectionMode,
    Scale2D, ScaleIntensity, ShiftAxis, Spectrum1DPipeline, Spectrum2DPipeline, SubtractBaseline,
    ZeroFill, ZeroFill2D, auto_phase_correct, auto_phase_correct_2d, contour_segments,
    ...
    phase_correct, phase_correct_2d, project_x, project_y, scale_2d, scale_intensity, shift_axis,
    slice_x_at_y_index, slice_y_at_x_index, subtract_baseline, zero_fill, zero_fill_2d,
};
pub use simulation::{
...
pub mod prelude {
    pub use crate::{
        ...
        AutoPhaseOptions, Axis, BaselineMethod, CsvSpectrum1D, CsvSpectrum2D, DetectedMultiplet,
        DetectedRange, DetectedZone, ExactSpectrumOptions, ExactSpinOptions, ExactTransition,
        Experiment, FftDirection, Integral, IntegralRegion, JCoupling, JCouplingGraph, LineShape,
        Metadata, MultipletDetectionOptions, MultipletKind, Nucleus, Peak, PeakAlignmentOptions,
        PeakPickOptions, PeakPolarity, PredictionLineShape, PredictionSet,
        PredictionSpectrumOptions, ProcessSpectrum1D, ProcessSpectrum2D, ProjectionMode,
        RSpinError, RangeDetectionOptions, Result, ScalarCoupling, SignalSummary1D,
        ...
        auto_phase_correct, auto_phase_correct_2d, decompose_exact_spin_half_1d, detect_multiplets,
        detect_ranges, detect_zones, exact_spin_half_transitions, extract_contours,
        integrate_region, normalize_max_abs, pick_peaks, read_jcamp_dx_1d, read_spectrum1d_csv,
        read_spectrum1d_json, read_spectrum2d_csv, read_spectrum2d_json, render_prediction_1d,
        scale_intensity, simulate_exact_spin_half_1d, subtract_baseline, write_jcamp_dx_1d,
