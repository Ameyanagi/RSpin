...
pub use io::{
    AgilentFid1D, BrukerFid1D, BrukerProcessed1D, CsvAnalysis1D, CsvAnalysis2D, CsvSpectrum1D,
    CsvSpectrum2D, JcampDx, JeolJdf1D, JsonAnalysis1D, JsonAnalysis2D, JsonProcessingRecipe1D,
    JsonProcessingRecipe2D, JsonSpectrum1D, JsonSpectrum2D, SpectrumReader, SpectrumWriter,
    read_agilent_fid_1d_dir, read_analysis1d_json, read_analysis2d_json, read_bruker_fid_1d_dir,
...
pub mod prelude {
    pub use crate::{
        ...
        BondOrder, BrukerFid1D, BrukerProcessed1D, BucketMatrix1D, BucketMatrix2D, BucketOptions1D,
        ...
        read_jcamp_dx_1d, read_jeol_jdf_1d_bytes, read_jeol_jdf_1d_file,
        read_processing_recipe_1d_json, read_processing_recipe_2d_json, read_spectrum1d_csv,
