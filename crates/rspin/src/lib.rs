...
pub use processing::{
    ...
    Scale2D, ScaleIntensity, Shift2DAxes, ShiftAxis, SineBellApodization, SineBellApodization2D,
    ...
    normalize_max_abs, offset_2d, offset_intensity, phase_correct, phase_correct_2d, project_x,
    project_y, resample_1d, resample_2d, scale_2d, scale_intensity, shift_2d_axes, shift_axis,
    sine_bell_apodization, sine_bell_apodization_2d, slice_x_at_y, slice_x_at_y_index,
    slice_y_at_x, slice_y_at_x_index, spectrum_area, spectrum_volume_2d, subtract_baseline,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        CsvSpectrum2D, DetectedMultiplet, DetectedRange, DetectedZone, DiscoveredSpectrumDimension,
        DiscoveredSpectrumDimensionCount, DiscoveredSpectrumPathCount, DiscoveredSpectrumSource,
        DiscoveredSpectrumSourcesExt, DiscoveredSpectrumSummary,
        ...
        EXACT_SPIN_OPTIONS_JSON_FORMAT, EXACT_TRANSITIONS_JSON_FORMAT, ElementShiftPredictor,
        ElementShiftRule, ExactSpectrum2DOptions, ExactSpectrumOptions,
        ExactSpinHalfResultWorkflow, ExactSpinHalfSpectrum1DResultWorkflow,
        ExactSpinHalfSpectrum1DWorkflow, ExactSpinHalfSpectrum2DResultWorkflow,
        ExactSpinHalfSpectrum2DWorkflow, ExactSpinHalfWorkflow, ExactSpinOptions, ExactSpinPair,
        ExactTransition, Experiment, FftDirection, GaussianApodization, GaussianApodization2D,
        Integral, Integral2D, IntegralRegion, IntegralRegion2D, J_COUPLING_GRAPH_JSON_FORMAT,
        JCoupling, JCouplingGraph, JcampDx, JcampDx2D, JcampDxVersion, JeolJdf1D, JeolJdf2D,
        JeolJdfInfo, JeolJdfVersion, JsonAnalysis1D, JsonAnalysis2D, JsonAssignmentSet,
        ...
        JsonProcessingRecipe2D, JsonSpectrumBundle, JsonSpinHalfSystem, LineShape, LoadWarning,
        ...
        LoadedSpectrum, MatrixClusterCut, MatrixClusterMetric, MatrixClusterResult,
        ...
        MultipletKind, NMREDATA_JSON_VERSION, NMREDATA_RECORD_JSON_FORMAT,
        NMREDATA_RECORDS_JSON_FORMAT, NMRML_SCHEMA_DIRECTORY, NMRML_SCHEMA_REPOSITORY, NmrMl1D,
        NmrMl2D, NmrMlDocumentInfo, NmrMlSchemaLocation, NmrMlVersion, NmreData, NmreDataAnalysis,
        NmreDataAssignment, NmreDataCoupling, NmreDataRecord, NmreDataRecords, NmreDataSignal1D,
        NmreDataSignal2D, NmreDataSpectrum, NmreDataSpectrumKind, NmreDataTag, NmreDataVersion,
        Normalize2DMaxAbs, Normalize2DVolume, NormalizeArea, NormalizeMaxAbs, Nucleus, Offset2D,
        OptimizedPeak, PREDICTION_JSON_FORMAT, PREDICTION_JSON_VERSION,
        PROCESSING_RECIPE_1D_FORMAT, PROCESSING_RECIPE_2D_FORMAT, PROCESSING_RECIPE_JSON_VERSION,
        Peak, PeakAlignedMatrix1D, PeakAlignmentOptions, PeakOptimizationOptions, PeakOptimizer,
        ...
        PredictionSpectrum2DOptions, PredictionSpectrum2DResultWorkflow,
        PredictionSpectrum2DWorkflow, PredictionSpectrumOptions, ProcessSpectrum1D,
        ProcessSpectrum2D, ProcessingOperation1D, ProcessingOperation2D, ProcessingRecipe1D,
        ProcessingRecipe2D, ProjectionMode, QuadraticPeakOptimizer, RSpinError, RSpinReader,
        RangeDetectionOptions, RenderPrediction1D, RenderPrediction1DResult, RenderPrediction2D,
        RenderPrediction2DResult, Resample1D, Resample2D, Result, SIMULATION_JSON_VERSION,
        SPECTRUM_1D_JSON_FORMAT, SPECTRUM_2D_JSON_FORMAT, SPECTRUM_BUNDLE_JSON_FORMAT,
        SPECTRUM_BUNDLE_JSON_VERSION, SPECTRUM_JSON_VERSION, SPIN_HALF_SYSTEM_JSON_FORMAT,
        ScalarCoupling, SelectedDiscoveredSpectrumSourcesExt, Shift2DAxes, SignalSummary1D,
        SignalSummary2D, SignalSummary2DOptions, SignalSummaryOptions, SimulateExactSpinHalf,
        SimulateExactSpinHalfResult, SineBellApodization, SineBellApodization2D,
        SourceDataKindCount, SourceFormatCount, SourcePathCount, SourceVendorCount,
        SpectralBucket1D, SpectralBucket2D, Spectrum1D, Spectrum1DBytes, Spectrum1DBytesFormat,
        Spectrum1DPathFormat, Spectrum1DTextWriter, Spectrum1DWriteFormat,
        Spectrum1DWritePathFormat, Spectrum2D, Spectrum2DAlignmentShift, Spectrum2DBytes,
        Spectrum2DBytesFormat, Spectrum2DPathFormat, Spectrum2DTextWriter, Spectrum2DWriteFormat,
        Spectrum2DWritePathFormat, SpectrumAnalysis1D, SpectrumAnalysis1DOptions,
        SpectrumAnalysis1DResultWorkflow, SpectrumAnalysis1DWorkflow, SpectrumAnalysis2D,
        SpectrumAnalysis2DOptions, SpectrumAnalysis2DResultWorkflow, SpectrumAnalysis2DWorkflow,
        SpectrumAnnotation, SpectrumBundle, SpectrumBundleLoader, SpectrumBundleSummary,
        SpectrumMatrix1D, SpectrumMatrix2D, SpectrumPathReader, SpectrumPathWriter, SpectrumReader,
        SpectrumTextFormat, SpectrumWriter, SpinHalf, SpinHalfSystem, TrapezoidalIntegrator, Unit,
        WarningPathCount, ZoneAlignedMatrix2D, ZoneAlignmentOptions, ZoneAlignmentResult2D,
        ...
        detect_spectrum2d_write_path_format, detect_zones, discover_spectra, discover_spectra_1d,
        ...
        discover_spectra_2d_summary, discover_spectra_2d_summary_relative_to,
        discover_spectra_by_source, discover_spectra_by_source_relative_to,
        discover_spectra_by_sources, discover_spectra_by_sources_relative_to,
        discover_spectra_many, discover_spectra_many_by_source,
        discover_spectra_many_by_source_relative_to, discover_spectra_many_by_sources,
        discover_spectra_many_by_sources_relative_to, discover_spectra_many_relative_to,
        discover_spectra_many_summary, discover_spectra_many_summary_relative_to,
        discover_spectra_relative_to, discover_spectra_summary,
        discover_spectra_summary_relative_to, exact_spin_half_transitions, extract_contours,
        gaussian_apodization, gaussian_apodization_2d, generate_spectrum_matrix_1d,
        generate_spectrum_matrix_2d, inspect_agilent_binary_bytes, inspect_agilent_binary_file,
        inspect_agilent_procpar, inspect_bruker_parameter_file, inspect_jeol_jdf_bytes,
        inspect_jeol_jdf_file, integrate_ranges, integrate_region, integrate_region_2d,
        integrate_regions, integrate_regions_2d, integrate_zones_2d, load, load_discovered_spectra,
        load_discovered_spectra_1d, load_discovered_spectra_1d_by_source,
        ...
        select_discovered_spectra_1d, select_discovered_spectra_1d_by_path,
        ...
        supported_bundle_source_data_kinds, supported_bundle_source_formats,
        supported_bundle_source_vendors, validate_exact_spectrum_2d_options,
        ...
        validate_exact_spin_options, validate_spin_half_system, write_analysis1d_csv,
        write_analysis1d_json, write_analysis2d_csv, write_analysis2d_json,
        ...
        write_exact_spectrum_options_json, write_exact_spin_options_json,
        write_exact_transitions_csv, write_exact_transitions_json, write_j_coupling_graph_json,
        write_jcamp_dx_1d, write_jcamp_dx_2d, write_nmredata_file, write_nmredata_record,
