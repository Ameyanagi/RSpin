...
pub use io::{
    ...
    JsonAnalysis1D, JsonAnalysis2D, JsonPrediction, JsonProcessingRecipe1D, JsonProcessingRecipe2D,
    JsonSpectrum1D, JsonSpectrum2D, NMRML_SCHEMA_DIRECTORY, NMRML_SCHEMA_REPOSITORY, NmrMl1D,
    ...
    write_analysis2d_csv, write_analysis2d_json, write_jcamp_dx_1d, write_nmredata_file,
    write_nmredata_record, write_nmredata_records, write_nmredata_records_file, write_nmrml_1d,
    write_nmrml_1d_file, write_nmrml_2d, write_nmrml_2d_file, write_prediction_json,
    write_processing_recipe_1d_json, write_processing_recipe_2d_json, write_spectrum1d_csv,
    write_spectrum1d_json, write_spectrum1d_path, write_spectrum2d_csv, write_spectrum2d_json,
    write_spectrum2d_path,
};
pub use prediction::{
...
pub mod prelude {
    pub use crate::{
        ...
        JeolJdf1D, JeolJdf2D, JsonAnalysis1D, JsonAnalysis2D, JsonPrediction,
        ...
        write_nmrml_2d, write_nmrml_2d_file, write_prediction_json,
        write_processing_recipe_1d_json, write_processing_recipe_2d_json, write_spectrum1d_csv,
        write_spectrum1d_json, write_spectrum1d_path, write_spectrum2d_csv, write_spectrum2d_json,
        write_spectrum2d_path,
    };
