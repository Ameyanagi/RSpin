...
pub use processing::{
    ...
    ZeroFill, ZeroFill2D, abs_1d, abs_2d, apply_processing_recipe_1d, apply_processing_recipe_2d,
...
pub mod prelude {
    pub use crate::{
        ...
        align_spectra_by_peak, apply_processing_recipe_1d, apply_processing_recipe_2d,
        ...
        integrate_region, integrate_region_2d, normalize_max_abs, pick_peaks, read_jcamp_dx_1d,
