...
pub use processing::{
    ...
    ProcessSpectrum1D, ProcessSpectrum2D, ProcessingOperation1D, ProcessingRecipe1D,
    ProcessingStep, ProjectionMode, Resample1D, Resample2D, Scale2D, ScaleIntensity, ShiftAxis,
    Spectrum1DPipeline, Spectrum2DPipeline, SubtractBaseline, ZeroFill, ZeroFill2D, abs_1d, abs_2d,
    apply_processing_recipe_1d, auto_phase_correct, auto_phase_correct_2d, contour_segments,
    crop_1d, crop_2d, exponential_apodization, exponential_apodization_2d, extract_contours,
    fft_1d, fft_2d, fit_baseline, magnitude_spectrum, normalize_2d_max_abs, normalize_max_abs,
    offset_intensity, phase_correct, phase_correct_2d, project_x, project_y, resample_1d,
    resample_2d, scale_2d, scale_intensity, shift_axis, slice_x_at_y, slice_x_at_y_index,
    slice_y_at_x, slice_y_at_x_index, subtract_baseline, zero_fill, zero_fill_2d,
};
pub use simulation::{
...
pub mod prelude {
    pub use crate::{
        ...
        ProcessSpectrum2D, ProcessingOperation1D, ProcessingRecipe1D, ProjectionMode, RSpinError,
        RangeDetectionOptions, Resample1D, Resample2D, Result, ScalarCoupling, SignalSummary1D,
        SignalSummary2D, SignalSummary2DOptions, SignalSummaryOptions, Spectrum1D, Spectrum2D,
        ...
        abs_1d, abs_2d, align_spectra_by_peak, apply_processing_recipe_1d, auto_phase_correct,
