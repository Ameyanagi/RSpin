...
pub use io::{
    BrukerProcessed1D, CsvAnalysis1D, CsvAnalysis2D, CsvSpectrum1D, CsvSpectrum2D, JcampDx,
    JsonAnalysis1D, JsonAnalysis2D, JsonProcessingRecipe1D, JsonProcessingRecipe2D, JsonSpectrum1D,
    JsonSpectrum2D, SpectrumReader, SpectrumWriter, read_analysis1d_json, read_analysis2d_json,
    read_bruker_processed_1d_dir, read_jcamp_dx_1d, read_processing_recipe_1d_json,
...
pub mod prelude {
    pub use crate::{
        Abs1D, Abs2D, AlignmentWindow, AnalyzeSpectrum1D, AnalyzeSpectrum2D, AnnotationTarget,
        AssignedAtom, Assignment, AssignmentSet, AssignmentTarget, Atom, AutoPhaseOptions, Axis,
        BaselineMethod, BilinearIntegrator2D, Bond, BondCorrelationRule, BondOrder,
        BrukerProcessed1D, BucketMatrix1D, BucketMatrix2D, BucketOptions1D, BucketOptions2D,
        ...
        Integral2D, IntegralRegion, IntegralRegion2D, JCoupling, JCouplingGraph, JsonAnalysis1D,
