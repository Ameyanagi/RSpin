...
pub use io::{
    ...
    JsonSpectrum2D, NmrMl1D, SpectrumReader, SpectrumWriter, read_agilent_fid_1d_dir,
...
pub mod prelude {
    pub use crate::{
        ...
        MultipletKind, NmrMl1D, Nucleus, Peak, PeakAlignedMatrix1D, PeakAlignmentOptions,
