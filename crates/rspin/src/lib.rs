...
pub use analysis::{
    ...
    SpectrumAlignmentShift, SpectrumAnalysis1D, SpectrumAnalysis1DOptions, SpectrumAnalysis2D,
    SpectrumAnalysis2DOptions, SpectrumMatrix1D, SpectrumMatrix2D, ThresholdRangeDetector,
...
pub mod prelude {
    pub use crate::{
        ...
        Integral2D, IntegralRegion, IntegralRegion2D, JCoupling, JCouplingGraph, LineShape,
        ...
        SpectrumAnalysis1DOptions, SpectrumAnalysis2D, SpectrumAnalysis2DOptions,
        SpectrumAnnotation, SpectrumMatrix1D, SpectrumMatrix2D, SpectrumReader, SpectrumWriter,
