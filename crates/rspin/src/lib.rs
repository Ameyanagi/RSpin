...
pub mod prelude {
    pub use crate::{
        ...
        NmrMlSchemaLocation, Nucleus, Peak, PeakAlignedMatrix1D, PeakAlignmentOptions,
        ...
        ProcessingRecipe2D, ProjectionMode, RSpinError, RangeDetectionOptions, RenderPrediction1D,
        ...
        SpectrumMatrix1D, SpectrumMatrix2D, SpectrumPathReader, SpectrumReader, SpectrumTextFormat,
        SpectrumWriter, SpinHalf, SpinHalfSystem, TrapezoidalIntegrator, Unit, ZoneAlignedMatrix2D,
