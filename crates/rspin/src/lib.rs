...
pub mod prelude {
    pub use crate::{
        ...
        load_spectra_many_strict_relative_to, load_spectra_relative_to, load_spectra_strict,
        load_spectra_strict_relative_to, load_spectrum_1d, load_spectrum_1d_by_source,
