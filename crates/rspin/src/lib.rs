...
pub use analysis::{
    ...
    align_spectra_by_zone_to_matrix, bucket_spectra_1d, bucket_spectra_2d, bucket_spectrum_1d,
...
pub mod prelude {
    pub use crate::{
        ...
        Spectrum1D, Spectrum2D, Spectrum2DAlignmentShift, SpectrumAnnotation, SpectrumMatrix1D,
        SpectrumMatrix2D, SpectrumReader, SpectrumWriter, SpinHalf, SpinHalfSystem,
        TrapezoidalIntegrator, Unit, ZoneAlignedMatrix2D, ZoneAlignmentOptions,
        ZoneAlignmentResult2D, ZoneConnectivity, ZoneDetectionOptions, abs_1d, abs_2d,
        align_spectra_by_peak, align_spectra_by_peak_to_matrix, align_spectra_by_zone,
        align_spectra_by_zone_to_matrix, apply_processing_recipe_1d,
