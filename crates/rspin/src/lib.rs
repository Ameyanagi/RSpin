...
pub use io::{
    AgilentFid1D, AgilentFid2D, BrukerFid1D, BrukerProcessed1D, BrukerProcessed2D, BrukerSer2D,
    ...
    JsonSpectrum2D, NmrMl1D, NmrMl2D, SpectrumReader, SpectrumWriter, read_agilent_fid_1d_dir,
    read_agilent_fid_2d_dir, read_analysis1d_json, read_analysis2d_json, read_bruker_fid_1d_dir,
...
pub mod prelude {
    pub use crate::{
        ...
        ExactSpinOptions, ExactSpinPair, ExactTransition, Experiment, FftDirection, Integral,
        Integral2D, IntegralRegion, IntegralRegion2D, JCoupling, JCouplingGraph, JeolJdf1D,
        JeolJdf2D, JsonAnalysis1D, JsonAnalysis2D, JsonProcessingRecipe1D, JsonProcessingRecipe2D,
        LineShape, MatrixClusterCut, MatrixClusterMetric, MatrixClusterResult,
        ...
        MultipletKind, NmrMl1D, NmrMl2D, Nucleus, Peak, PeakAlignedMatrix1D, PeakAlignmentOptions,
