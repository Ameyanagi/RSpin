...
pub use io::{
    ...
    CsvAnalysis1D, CsvAnalysis2D, CsvSpectrum1D, CsvSpectrum2D, JcampDx, JeolJdf1D, JsonAnalysis1D,
    JsonAnalysis2D, JsonProcessingRecipe1D, JsonProcessingRecipe2D, JsonSpectrum1D, JsonSpectrum2D,
    SpectrumReader, SpectrumWriter, read_agilent_fid_1d_dir, read_agilent_fid_2d_dir,
...
pub mod prelude {
    pub use crate::{
        ...
        JsonAnalysis1D, JsonAnalysis2D, JsonProcessingRecipe1D, JsonProcessingRecipe2D, LineShape,
