...
pub use analysis::{
    ...
    bucket_spectrum_1d, bucket_spectrum_2d, detect_multiplets, detect_ranges, detect_zones,
...
pub mod prelude {
    pub use crate::{
        ...
        BondOrder, BucketMatrix1D, BucketMatrix2D, BucketOptions1D, BucketOptions2D, Crop1D,
        Crop2D, CsvSpectrum1D, CsvSpectrum2D, DetectedMultiplet, DetectedRange, DetectedZone,
        ...
        MatrixGenerationOptions, Metadata, Molecule, MultipletDetectionOptions, MultipletKind,
        Nucleus, Peak, PeakAlignedMatrix1D, PeakAlignmentOptions, PeakPickOptions, PeakPolarity,
        ...
        bucket_spectra_1d, bucket_spectra_2d, bucket_spectrum_1d, bucket_spectrum_2d, crop_1d,
