...
pub use io::{
    AgilentFid1D, BrukerFid1D, BrukerProcessed1D, BrukerProcessed2D, BrukerSer2D, CsvAnalysis1D,
    CsvAnalysis2D, CsvSpectrum1D, CsvSpectrum2D, JcampDx, JeolJdf1D, JsonAnalysis1D,
    JsonAnalysis2D, JsonProcessingRecipe1D, JsonProcessingRecipe2D, JsonSpectrum1D, JsonSpectrum2D,
    SpectrumReader, SpectrumWriter, read_agilent_fid_1d_dir, read_analysis1d_json,
    read_analysis2d_json, read_bruker_fid_1d_dir, read_bruker_processed_1d_dir,
    read_bruker_processed_2d_dir, read_bruker_ser_2d_dir, read_jcamp_dx_1d, read_jeol_jdf_1d_bytes,
    read_jeol_jdf_1d_file, read_processing_recipe_1d_json, read_processing_recipe_2d_json,
    ...
    write_jcamp_dx_1d, write_processing_recipe_1d_json, write_processing_recipe_2d_json,
...
pub mod prelude {
    pub use crate::{
        Abs1D, Abs2D, AgilentFid1D, AlignmentWindow, AnalyzeSpectrum1D, AnalyzeSpectrum2D,
        AnnotationTarget, AssignedAtom, Assignment, AssignmentSet, AssignmentTarget, Atom,
        AutoPhaseOptions, Axis, BaselineMethod, BilinearIntegrator2D, Bond, BondCorrelationRule,
        BondOrder, BrukerFid1D, BrukerProcessed1D, BrukerProcessed2D, BrukerSer2D, BucketMatrix1D,
        BucketMatrix2D, BucketOptions1D, BucketOptions2D, ClusterMerge, ConsensusPeak1D,
        ConsensusPeakMember1D, ConsensusPeakOptions, ConsensusRange1D, ConsensusRangeMember1D,
        ConsensusRangeOptions, ConsensusZone2D, ConsensusZoneMember2D, ConsensusZoneOptions,
        Crop1D, Crop2D, CsvAnalysis1D, CsvAnalysis2D, CsvSpectrum1D, CsvSpectrum2D,
        ...
        IntegralRegion2D, JCoupling, JCouplingGraph, JeolJdf1D, JsonAnalysis1D, JsonAnalysis2D,
        ...
        Spectrum1D, Spectrum2D, Spectrum2DAlignmentShift, SpectrumAnalysis1D,
        ...
        SpinHalfSystem, TrapezoidalIntegrator, Unit, ZoneAlignedMatrix2D, ZoneAlignmentOptions,
        ZoneAlignmentResult2D, ZoneConnectivity, ZoneDetectionOptions, abs_1d, abs_2d,
        align_spectra_by_peak, align_spectra_by_peak_to_matrix, align_spectra_by_zone,
        align_spectra_by_zone_to_matrix, analyze_assigned_spectrum_1d,
        ...
        pick_peaks, predict_molecule_with_rules, read_agilent_fid_1d_dir, read_analysis1d_json,
        read_analysis2d_json, read_bruker_fid_1d_dir, read_bruker_processed_1d_dir,
        read_bruker_processed_2d_dir, read_bruker_ser_2d_dir, read_jcamp_dx_1d,
        read_jeol_jdf_1d_bytes, read_jeol_jdf_1d_file, read_processing_recipe_1d_json,
