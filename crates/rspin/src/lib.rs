...
pub mod prelude {
    pub use crate::{
        ...
        select_discovered_spectra_by_dimension_and_sources, select_discovered_spectra_by_source,
        select_discovered_spectra_by_source_path, select_discovered_spectra_by_source_path_prefix,
        select_discovered_spectra_by_sources, shift_2d_axes, simulate_exact_spin_half_1d,
        simulate_exact_spin_half_2d, sine_bell_apodization, sine_bell_apodization_2d, slice_x_at_y,
        slice_y_at_x, spectrum_area, spectrum_volume_2d, subtract_baseline,
        summarize_discovered_spectra, summarize_signals_2d, supported_bundle_source_data_kinds,
